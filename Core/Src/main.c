...
int main(void)
{
  ...
  SystemClock_Config();
    ...
    retval = mqtt_transport_init(true, (uint8_t *)MQTT_CLIENT_ID, NULL, NULL, MQTT_KEEP_ALIVE);
    ...
    retval = mqtt_transport_connect(SOCKET_MQTT, 1, g_mqtt_buf, MQTT_BUF_MAX_SIZE,(uint8_t *) MQTT_DOMAIN, 8883, &g_mqtt_tls_context);
